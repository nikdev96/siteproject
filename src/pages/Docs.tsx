    ...
    <section className="py-10 md:py-14 min-h-[70vh]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 md:gap-6">
          <div>
            <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight">Документы</h1>
          ...
          <div className="w-full md:max-w-xs">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-300 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              value={searchInput}
