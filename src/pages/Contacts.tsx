          ...
          >
            ...
            <div className="sm:col-span-2">
              ...
              <button
                ...
                onMouseMove={isSubmitting || submitSuccess ? undefined : handleMouseMove}
                onMouseLeave={isSubmitting || submitSuccess ? undefined : handleMouseLeave}
                className={`inline-flex items-center gap-2 rounded-xl px-6 py-3 text-white text-sm font-medium shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all relative overflow-hidden ${
                  isSubmitting || submitSuccess
                    ? 'bg-slate-400 cursor-not-allowed'
                    : ''
                }`}
                style={isSubmitting || submitSuccess ? undefined : {
